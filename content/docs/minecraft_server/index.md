...
![Voice Menu](svg_menu.png "If you have trouble opening the menu, you can also just type `/svg pswd <new-password>` to set a password without the menu.")
